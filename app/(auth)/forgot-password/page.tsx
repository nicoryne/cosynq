...
export const metadata: Metadata = {
  ...
  description: 'Regain access to your cosmic sanctuary on cosynq.',
};
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full pointer-events-none" aria-hidden="true">
        ...
        <div className="absolute bottom-[10%] left-[10%] w-[400px] h-[400px] bg-secondary/15 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '3s' }} />
      </div>

      <div className="relative z-10 w-full max-w-lg">
        {/* Forgot Password form in glassmorphic card */}
