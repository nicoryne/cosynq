            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-8 text-xs font-black uppercase tracking-[0.2em] text-muted-foreground/60 pt-6">
              ...
              {profile.facebookUrl && (
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="flex items-center gap-3 hover:text-[#1877F2] transition-all group"
                >
                   <div className="size-8 rounded-xl bg-[#1877F2]/10 flex items-center justify-center group-hover:bg-[#1877F2]/20 transition-colors shadow-glow-[#1877F2]/20">
                  ...
                  <span className="underline underline-offset-8 decoration-[#1877F2]/30 group-hover:decoration-[#1877F2]">Verified Identity</span>
                </a>
              )}
            </div>
          </div>
